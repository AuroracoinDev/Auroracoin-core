...
environ_default("CLONE_URL", "https://github.com/auroracoin/auroracoin.git")
...
environ_default("BUILD_PATH", "/mnt/auroracoin")
...
environ_default("GITHUB_REPO", "auroracoin/auroracoin")
