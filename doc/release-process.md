...
* see https://github.com/auroracoin/auroracoin/blob/master/doc/translation_process.md#syncing-with-transifex
...
##perform gitian builds
 ...
 Fetch and build inputs: (first time, or when dependency versions change)
	...
	./bin/gbuild ../auroracoin/contrib/gitian-descriptors/gitian-osx-native.yml
	mv build/out/osx-*.tar.gz inputs/
	./bin/gbuild ../auroracoin/contrib/gitian-descriptors/gitian-osx-depends.yml
	mv build/out/osx-*.tar.gz inputs/
	./bin/gbuild ../auroracoin/contrib/gitian-descriptors/gitian-osx-qt.yml
	mv build/out/osx-*.tar.gz inputs/

 The expected SHA256 hashes of the intermediate inputs are:

    35c3dfd8b9362f59e81b51881b295232e3bc9e286f1add193b59d486d9ac4a5c  auroracoin-deps-linux32-gitian-r5.zip
    571789867d172500fa96d63d0ba8c5b1e1a3d6f44f720eddf2f93665affc88b3  auroracoin-deps-linux64-gitian-r5.zip
    ...
    97e62002d338885336bb24e7cbb9471491294bd8857af7a83d18c0961f864ec0  auroracoin-deps-win32-gitian-r11.zip
    ee3ea2d5aac1a67ea6bfbea2c04068a7c0940616ce48ee4f37c264bb9d4438ef  auroracoin-deps-win64-gitian-r11.zip
 ...
 Build auroracoind and auroracoin-qt on Linux32, Linux64, and Win32:
	...
	popd
        ./bin/gbuild --commit auroracoin=v${VERSION} ../auroracoin/contrib/gitian-descriptors/gitian-osx-auroracoin.yml
        ./bin/gsign --signer $SIGNER --release ${VERSION}-osx --destination ../gitian.sigs/ ../auroracoin/contrib/gitian-descriptors/gitian-osx-auroracoin.yml
	pushd build/out
	mv Auroracoin-Qt.dmg ../../../
	popd
	popd
