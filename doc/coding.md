...
- ThreadRPCServer : Remote procedure call handler, listens on port 12341 for connections and services them.

- BitcoinMiner : Generates auroracoins (if wallet is enabled).
