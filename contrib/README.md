...
A Linux bash script that will set up tc to limit the outgoing bandwidth for connections to the Bitcoin network. This means one can have an always-on auroracoind instance running, and another local auroracoinnd/auroracoin-qt instance which connects to this node and receives blocks from it.
